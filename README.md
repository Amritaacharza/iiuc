...
<head>
	...
	<script src="https://www.iiuc.ac.bd/home/show-js/js4dZfTMdaau8PzjIZ8h9RdataTables.bootstrap.mineF4If9teybBctZYYHNDx"></script>
				...
				<ul style="margin-top:5px;" class="tnav roles" role="navigation">
					...
					<!--<li class='dropdown'><a href='#' class='dropdown-toggle' data-toggle='dropdown' style="font-family:Cambria;font-size:14px;">&nbsp;&nbsp;Divisions<b class='caret'></b></a> 
						<ul class='dropdown-menu'>
							...
							<li><a href="https://www.iiuc.ac.bd/divisions/stad">Student Affairs Division</a></li>
	...
	<div class="container">
		<div style="margin-left:0px;" class="row">
			<ul class="mnav main" role="navigation">
							...
							<div class="row">
								<div class="col-sm-4">
									<ul>
										...
										<li><a href="https://www.iiuc.ac.bd/about/contact">Contact Us</a></li>
									</ul>
								</div>
								<div class="col-sm-3">
									<h4>Message</h4>
							...
							<div class="row">
								<div class="col-sm-3">
									<ul>
										...
										<li><a href="https://www.iiuc.ac.bd/administration/treasurer">Treasurer</a></li>
										<li><a href="https://www.iiuc.ac.bd/administration/finance-chairman">Chairman Finance Commiittee</a></li>
										<li><a href="https://www.iiuc.ac.bd/administration/registrar">Registrar</a></li>
										<li><a href="https://www.iiuc.ac.bd/administration/syndicate">Syndicate</a></li>
										<li><a href="https://www.iiuc.ac.bd/administration/academic-council">Academic Council</a></li>
										<li><a href="https://www.iiuc.ac.bd/administration/deans">Deans of the Faculties</a></li>
										<li><a href="https://www.iiuc.ac.bd/administration/proctors">The Proctorial Body</a></li>
										<li><a href="https://www.iiuc.ac.bd/administration/coe">Controller of Exams</a></li>
				...
				<li><a href="#"><i class="fa fa-building"></i>  Faculties <b class="caret" aria-hidden="true"></b></a>
					<div class="mainnav-details">
						<div class="container">
							<div class="row">
								<div class="col-sm-4">
									<h3 style="font-size:18px;font-weight:bold;"><a href="https://www.iiuc.ac.bd/faculties/fsis">Faculty of Shariah and Islamic Studies</a></h3>
									<div class="col-sm-4">
									<a href=""><span><img src="https://www.iiuc.ac.bd/home/show-image/faculty4dZfTMdaau8PzjIZ8h9RDean-Shariah-Dr-Shakermz6HpP0nio2mUtRFuJcx" alt="iiuc" style="width:95%;" class="img img-responsive" /></span>
										<span><span>Prof. Dr. Shaker Alam Shaoque, Dean
										</span></span></a>
									</div>
									<div class="col-sm-8">
										<ul>
											<li><a href="https://www.iiuc.ac.bd/qsis">Qur&#8217;anic Sciences and Islamic Studies (QSIS)</a></li>
											<li><a href="https://www.iiuc.ac.bd/dis">Da&#8217;wah &#038; Islamic Studies (DIS)</a></li>
											<li><a href="https://www.iiuc.ac.bd/shis">Science of Hadith and Islamic Studies (SHIS)</a></li>											
										</ul>
									</div>
								</div>
								<div class="col-sm-4">
							...
							<div class="row">	
								...
								<div class="col-sm-3">
									<ul class="nav nav-pills nav-stacked">										
										...
										<li style="background:none;"><a href="https://www.iiuc.ac.bd/home/offletter" style="color:white;font-size:14px;width:100%;" class="gradient-button gradient-button-3">Print Offer Letter</a></li>
									</ul>
								</div>
								<div class="col-sm-6">
								  ...
								  <div class="col-sm-6">
									<div class="tab-content">
									  ...
									  <div class="tab-pane fade" id="v-pills-messages" >
										...
										<ul>
											<li><a href="https://www.iiuc.ac.bd/program/dlibrary">Post graduate Diploma in Library and Information Science</a></li>
											<li><a href="https://www.iiuc.ac.bd/program/dall">Diploma in Arabic Language</a></li>
																					
										</ul>
									  </div>
									  <div class="tab-pane fade" id="ac-calendar">											
											<ul>
												<li><a href="https://www.iiuc.ac.bd/academic/bcalendar">Bachelor Program</a></li>
												<li><a href="https://www.iiuc.ac.bd/academic/mcalendar">Master Program</a></li>
												<li><a href="https://www.iiuc.ac.bd/academic/mbacalendar">MBA/MBM Program</a></li>
												<li><a href="https://www.iiuc.ac.bd/academic/dcalendar">PGDLIS</a></li>										
											</ul>
									   </div>
				...
				<li><a href="#"><i class="fa fa-rss"></i> Research &amp; Publication <b class="caret" aria-hidden="true"></b></a>
					<div class="mainnav-details">
						<div class="container">
							<div class="row">
								<div class="col-sm-3">
									<h4>Center for Research &#038; Publication</h4>
									<ul>
										<li><a href="https://www.iiuc.ac.bd/research/crp">About CRP</a></li>
										<li><a href="https://www.iiuc.ac.bd/research/crp-list">Member List of CRP</a></li>
										<li><a href="https://www.iiuc.ac.bd/research/crp-news">CRP News &#038; Notices</a></li>										
										
									</ul>
								</div>
								<div class="col-sm-3">									
									<ul>
										<li><a href="https://www.iiuc.ac.bd/research/journal">Journals published by IIUC</a></li>
										<li><a href="https://www.iiuc.ac.bd/research/award">Research Award</a></li>
										<li><a href="https://www.iiuc.ac.bd/research/publication">Research Publication</a></li>
										<li><a href="https://www.iiuc.ac.bd/research/current-research">Current Research Projects</a></li>
										<li><a href="https://www.iiuc.ac.bd/research/conference">International Conference</a></li>
										<li><a href="https://www.iiuc.ac.bd/research/collaboration">International Collaboration</a></li>
										<li><a href="https://www.iiuc.ac.bd/research/usim-phd">USIM Ph.D Programs</a></li>
										<li><a href="https://www.iiuc.ac.bd/research/google-scholar">Google Scholar Profile</a></li>
									</ul>
								</div>
							</div>
						</div>
				...
				<li><a href="#"><i class="fa fa-steam"></i>  IQAC <b class="caret" aria-hidden="true"></b></a>
					<div class="mainnav-details">
						<div class="container">
							<div class="row">
								<div class="col-sm-3">
									<h4>About</h4>
									<ul>
										<li><a href="https://www.iiuc.ac.bd/iqac/">About IQAC</a></li>
										<li><a href="https://www.iiuc.ac.bd/iqac/mission">Mission and Vision</a></li>
										<li><a href="https://www.iiuc.ac.bd/iqac/official">IQAC Officials</a></li>
								...
								<div class="col-sm-3">
									...
									<ul>
										...
										<!--<li><a href="https://www.iiuc.ac.bd/iqac/asurvey-result">Survey Questionnaire for Academics</a></li>
		...
		if(prg_id!=""){
			...
			if(programme_id==1){
				if(department_id==1){
					...
					window.location.replace(base_url+"program/cce");
				}else if(department_id==6){
						...
						<div class="row">
							<div class="container-fluid">
								<ul style="padding-right:20px;" class="nav nav-pills nav-stacked">
									...
									<li style="background:none;"><a href="https://www.iiuc.ac.bd/home/test-result" style="color:blue;font-size:14px;width:100%;background:pink;border: 3px solid #115c45;" class="gradient-button gradient-button-3">Result of Admission Test</a></li>
...
<!--
<div class="container-fluid">	
	<div class="container"><h2 align="center"><small>Online Admission</small></h2></div>
</div>-->
<!--<div class="container-fluid">
	<div class="row">
		<div class="transparent container">
			<div style="padding-left:0px;" class="col-sm-2">
				<div style="background:linear-gradient(to bottom, rgba(59,183,120,1) 0%,#3B5998 100%);box-shadow: 5px 5px 5px #888888;min-height:100px;margin-top:0px;" class="tuyin well">
					<h2 align="center"><a href="https://www.iiuc.ac.bd/home/apply-online" style="background:#005C25;" class="btn btn-info">Apply Online</a></h2>
				</div>
			</div>
			<div class="col-sm-2">
				<div style="background:linear-gradient(to bottom, rgba(59,183,120,1) 0%,#3B5998 100%);box-shadow: 5px 5px 5px #888888;min-height:100px;margin-top:0px;" class="tuyin well">
					<h2 align="center"><a href="https://www.iiuc.ac.bd/home/dacard" style="background:#005C25;" class="btn btn-info">Print Admit Card</a></h2>
				</div>
			</div>
			<div class="col-sm-2">
				<div style="background:linear-gradient(to bottom, rgba(59,183,120,1) 0%,#3B5998 100%);box-shadow: 5px 5px 5px #888888;min-height:100px;margin-top:0px;" class="tuyin well">
					<h2 align="center"><a href="https://www.iiuc.ac.bd/home/daform" style="background:#005C25;" class="btn btn-info">Admission Form</a></h2>
				</div>
			</div>
			<div class="col-sm-2">
				<div style="background:linear-gradient(to bottom, rgba(59,183,120,1) 0%,#3B5998 100%);box-shadow: 5px 5px 5px #888888;min-height:100px;margin-top:0px;" class="tuyin well">
					<h2 align="center"><a href="https://www.iiuc.ac.bd/home/admission-instruction" style="background:#005C25;" class="btn btn-info">How to Apply</a></h2>
				</div>
			</div>
			<div style="padding-right:0px;" class="col-sm-2">
				<div style="background:linear-gradient(to bottom, rgba(59,183,120,1) 0%,#3B5998 100%);box-shadow: 5px 5px 5px #888888;min-height:100px;margin-top:0px;" class="tuyin well">
					<h2 align="center"><a href="https://www.iiuc.ac.bd/program/advertisements" style="background:#005C25;" class="btn btn-info">Advertisement</a></h2>
				</div>
			</div>
			<div class="col-sm-2">
				<div style="background:linear-gradient(to bottom, rgba(59,183,120,1) 0%,#3B5998 100%);box-shadow: 5px 5px 5px #888888;min-height:100px;margin-top:0px;" class="tuyin well">
					<h2 align="center"><a href="https://www.iiuc.ac.bd/home/offletter" style="background:#005C25;" class="btn btn-info">Offer Letter</a></h2>
				</div>
			</div>
		</div>
	</div>	
		...
		<div class="container">
			<div class="col-sm-3 col-md-3 col-lg-3 col-xs-3">
				...
				<div style="display:block;width:100%;">
					<h3 align="center">Hon’ble Chancellor</h3>
					<p align="center"><strong>Md. Abdul Hamid</strong></p>
				</div>
			</div>
			<div  class="col-sm-3 col-md-3 col-lg-3 col-xs-3">
				<table align="center">
					<tr>
						<td>
							<div style="margin-bottom:0px;" class="round-frame">
								<img src="https://www.iiuc.ac.bd/home/show-image/img4dZfTMdaau8PzjIZ8h9Rabu-rezamz6HpP0nio2mUtRFuJcx" style="width:99%;" class="img img-responsibve" alt="Prof. Dr. Abu Reza Muhammad Nadwi, MP">
							</div>
						</td>
					</tr>
				</table>	
				<div style="clear:both;"></div>
				<div style="display:block;width:100%;">
					<h3 align="center">Hon’ble Chairman</h3>
					<p align="center"><strong>Prof. Dr. Abu Reza Md. Nezamuddin Nadwi, MP</strong></p>
				</div>
			</div>
			<div  class="col-sm-3 col-md-3 col-lg-3 col-xs-3">
				<table align="center">
					<tr>
						<td>
							<div style="margin-bottom:0px;" class="round-frame">
								<img src="https://www.iiuc.ac.bd/home/show-image/img4dZfTMdaau8PzjIZ8h9Rprof-arifmz6HpP0nio2mUtRFuJcx" style="width:100%;" class="img img-responsibve" alt="Prof. Md. Anwarul Azim Arif">
							</div>
						</td>
					</tr>
				</table>
				<div style="clear:both;"></div>
				<div style="display:block;width:100%;">
					<h3 align="center">Hon’ble VC</h3>
					<p align="center"><strong>Prof. Md. Anwarul Azim Arif</strong></p>
				</div>
			...
			<div  class="col-sm-3 col-md-3 col-lg-3 col-xs-3">
				<table align="center">
					<tr>
						<td>
							<div style="margin-bottom:0px;" class="round-frame">
								<img src="https://www.iiuc.ac.bd/home/show-image/img4dZfTMdaau8PzjIZ8h9Rmasrul-mowlamz6HpP0nio2mUtRFuJcx" style="width:99%;" class="img img-responsibve" alt="Prof. Dr. Mohammad Masrurul Mowla">
							</div>
						</td>
					</tr>
				</table>
				<div style="clear:both;"></div>
				<div style="display:block;width:100%;">
					<h3 align="center">Hon’ble Pro VC</h3>
					<p align="center"><strong>Prof. Dr. Mohammad Masrurul Mowla</strong></p>
				</div>
			</div>
		</div>
	</div>
...
<!--KF INTRO WRAP END-->
<div style='width:100%;height:3px;background:rgba(59,183,120,1);'></div>
<div class="container-fluid">
	<div class="row">
		<div class="transparent container">
			<div style="padding-left:0px;" class="col-sm-2">
				<div style="background:rgba(59,183,120,1);box-shadow: 10px 10px 5px #888888;" class="tuyin well">
					<img src="https://www.iiuc.ac.bd/home/show-image/images4dZfTMdaau8PzjIZ8h9RiiuclogocdNHvOtQ2AD9TLJcKorf" align="center" style="max-height:100px;"/>
					<h5 align="center" style="padding-top:8px;padding-bottom:8px;margin-left: -10px;border-top:1px solid white;" class="slider-text-head">
						<a href="https://www.iiuc.ac.bd/academic/policies" style="color:white;">Academic Policies</a>
					</h5>
				</div>
			</div>
			<div class="col-sm-2">
				<div style="background:rgba(59,183,120,1);box-shadow: 10px 10px 5px #888888;" class="tuyin well">
					<img src="https://www.iiuc.ac.bd/home/show-image/images4dZfTMdaau8PzjIZ8h9Rdegree-logocdNHvOtQ2AD9TLJcKorf" align="center" style="max-height:100px;"/>
					<h5 align="center" style="padding-top:8px;padding-bottom:8px;margin-left: -10px;border-top:1px solid white;" class="slider-text-head">
					<a href="https://www.iiuc.ac.bd/program/bcriteria" style="color:white;">Degree Program</a></h5>
				</div>
			</div>
			<div class="col-sm-2">
				<div style="background:rgba(59,183,120,1);box-shadow: 10px 10px 5px #888888;" class="tuyin well">
					<img src="https://www.iiuc.ac.bd/home/show-image/images4dZfTMdaau8PzjIZ8h9Rresearch_publicationscdNHvOtQ2AD9TLJcKorf" align="center" style="max-height:100px;"/>
					<h5 align="center" style="padding-top:8px;padding-bottom:8px;margin-left: -10px;border-top:1px solid white;" class="slider-text-head">
					<a href="https://www.iiuc.ac.bd/research/crp" style="color:white;">Research & Publication</a>
					</h5>
				</div>
			</div>
			<div style="padding-right:0px;" class="col-sm-2">
				<div style="background:rgba(59,183,120,1);box-shadow: 10px 10px 5px #888888;" class="tuyin well">
					<img src="https://www.iiuc.ac.bd/home/show-image/images4dZfTMdaau8PzjIZ8h9Rvision-missioncdNHvOtQ2AD9TLJcKorf" align="center" style="max-height:100px;"/>
					<h5 align="center" style="padding-top:8px;padding-bottom:8px;margin-left: -10px;border-top:1px solid white;" class="slider-text-head">
					<a href="https://www.iiuc.ac.bd/about/mission" style="color:white;">Mission & Vision</a>
					</h5>
				</div>
			</div>
			<div style="padding-right:0px;" class="col-sm-2">
				<div style="background:rgba(59,183,120,1);box-shadow: 10px 10px 5px #888888;" class="tuyin well">
					<img src="https://www.iiuc.ac.bd/home/show-image/images4dZfTMdaau8PzjIZ8h9Rfinancial-aid-iconcdNHvOtQ2AD9TLJcKorf" align="center" style="max-height:100px;"/>
					<h5 align="center" style="padding-top:8px;padding-bottom:8px;margin-left: -10px;border-top:1px solid white;" class="slider-text-head">
					<a href="https://www.iiuc.ac.bd/academic/financial-aid" style="color:white;">Financial Aid</a>
					</h5>
				</div>
			</div>
			<div style="padding-right:0px;" class="col-sm-2">
				<div style="background:rgba(59,183,120,1);box-shadow: 10px 10px 5px #888888;" class="tuyin well">
					<img src="https://www.iiuc.ac.bd/home/show-image/images4dZfTMdaau8PzjIZ8h9RrulescdNHvOtQ2AD9TLJcKorf" align="center" style="max-height:100px;"/>
					<h5 align="center" style="padding-top:8px;padding-bottom:8px;margin-left: -10px;border-top:1px solid white;" class="slider-text-head">
					<a href="https://www.iiuc.ac.bd/iqac/rules-regulations" style="color:white;">Rules & Regulations</a>
					</h5>
				</div>
			</div>
		</div>
...
<section class="edu2_new_wrap">
	...
	<div class="container">
					<svg preserveAspectRatio="none" viewBox="0 0 100 102" height="100" width="100%" version="1.1" xmlns="http://www.w3.org/2000/svg" style="fill:white;">
		...
		<div class="row">
				...
				<div class="edu2_new_des">
					<div class="row">
							...
							<div  class="edu2_event_des">
								<h4>November</h4>
								<p>জাতি গঠনে নারীদের অগ্রণী ভুমিকা অপরিহার্য্য -প্রফেসর ড. আবু রেজা নদভী এম.পি</p>
								<ul   class="post-option">
									<li style="color:white;"></li>
								</ul>
								<a href="https://www.iiuc.ac.bd/home/news-details/182" class="readmore">read more<i class="fa fa-long-arrow-right"></i></a>
								<span >07</span>
							</div>
						</div>
						<div class="col-sm-5 col-md-5 col-lg-5 col-xs-5 thumb">
							<figure><img src="https://www.iiuc.ac.bd/home/show-image/news4dZfTMdaau8PzjIZ8h9R20214dZfTMdaau8PzjIZ8h9R182-news-6357mz6HpP0nio2mUtRFuJcx" style="width:100%;height:170px;border-radius: 15%;" class="img img-responsive" alt=""/>
								<figcaption><a href="https://www.iiuc.ac.bd/home/news-details/182"><i class="fa fa-plus"></i></a></figcaption>
							</figure>
						</div>
					</div>
				</div>
			...
			<div class="col-md-6">
				<div class="edu2_new_des">
					<div class="row">
						<div class="col-sm-5 col-md-5 col-lg-5 col-xs-5 thumb">
							<figure><img src="https://www.iiuc.ac.bd/home/show-image/news4dZfTMdaau8PzjIZ8h9R20214dZfTMdaau8PzjIZ8h9R181-news-282mz6HpP0nio2mUtRFuJcx" style="width:100%;height:170px;border-radius: 15%;" class="img img-responsive" alt=""/>
								<figcaption><a href="https://www.iiuc.ac.bd/home/news-details/181"><i class="fa fa-plus"></i></a></figcaption>
							</figure>
						</div>
						<div class="col-sm-7 col-md-7 col-lg-7 col-xs-7">
							<div  class="text-right edu2_event_des">
								<h4>September</h4>
								<p>আন্তর্জাতিক ইসলামী বিশ্ববিদ্যালয় চট্টগ্রাম প্রতিষ্ঠার ঐতিহাসিক পটভূমি</p>
								<ul   class="post-option">
									<li style="color:white;"></li>
								</ul>
								<a href="https://www.iiuc.ac.bd/home/news-details/181" class="readmore">read more<i class="fa fa-long-arrow-right"></i></a>
								<span >08</span>
							</div>
						</div>
					</div>
				...
				<div class="edu2_new_des">
					<div class="row">
						<div class="col-sm-7 col-md-7 col-lg-7 col-xs-7">
							<div  class="edu2_event_des">
								<h4>August</h4>
								<p>বঙ্গবন্ধু বেঁচে থাকলে ২০০০ সালেই উন্নত দেশ হতো বাংলাদেশ</p>
								<ul   class="post-option">
									<li style="color:white;">আইআইইউসি&apos;র শোক সভায় মন্ত্রী তাজুল ইসলাম</li>
								</ul>
								<a href="https://www.iiuc.ac.bd/home/news-details/180" class="readmore">read more<i class="fa fa-long-arrow-right"></i></a>
								<span >15</span>
							</div>
						</div>
						<div class="col-sm-5 col-md-5 col-lg-5 col-xs-5 thumb">
							<figure><img src="https://www.iiuc.ac.bd/home/show-image/news4dZfTMdaau8PzjIZ8h9R20214dZfTMdaau8PzjIZ8h9R180-news-5604cdNHvOtQ2AD9TLJcKorf" style="width:100%;height:170px;border-radius: 15%;" class="img img-responsive" alt=""/>
								<figcaption><a href="https://www.iiuc.ac.bd/home/news-details/180"><i class="fa fa-plus"></i></a></figcaption>
							</figure>
						</div>
					</div>
				</div>
			...
			<div class="col-md-6">
				<div class="edu2_new_des">
					<div class="row">
						<div class="col-sm-5 col-md-5 col-lg-5 col-xs-5 thumb">
							<figure><img src="https://www.iiuc.ac.bd/home/show-image/news4dZfTMdaau8PzjIZ8h9R20214dZfTMdaau8PzjIZ8h9R179-news-1680mz6HpP0nio2mUtRFuJcx" style="width:100%;height:170px;border-radius: 15%;" class="img img-responsive"  alt=""/>
								<figcaption><a href="https://www.iiuc.ac.bd/home/news-details/179"><i class="fa fa-plus"></i></a></figcaption>
							</figure>
						</div>
						<div class="col-sm-7 col-md-7 col-lg-7 col-xs-7">
							<div  class="text-right edu2_event_des">
								<h4>August</h4>
								<p>জাতীয় শোক দিবস ২০২১ উপলক্ষে আই-আই-ইউ-সির ব্যাপক প্রস্তুতি।</p>
								<ul   class="post-option">
									<li style="color:white;"></li>
								</ul>
								<a href="https://www.iiuc.ac.bd/home/news-details/179" class="readmore">read more<i class="fa fa-long-arrow-right"></i></a>
								<span >12</span>
							</div>
						</div>
					</div>
...
<div class="grey_div">
	<div class="container">
		<div class="row news-story">
			...
			<div class="owl_carousel_story col-lg-12">
									<div class="story item">
						<a href="https://www.iiuc.ac.bd/home/news-details/178">
							<span>
								<img src="https://www.iiuc.ac.bd/home/show-image/news4dZfTMdaau8PzjIZ8h9R20214dZfTMdaau8PzjIZ8h9R178-news-4897mz6HpP0nio2mUtRFuJcx" width="260px" height="125px">
							</span>
							<span>
								<span style='font-size:12px;'><b>১৫ আগস্ট জাতীয় শোক দিবস ২০২১ উপলক্ষে রচনা  প্রতিযোগিতা</b><span><br/>
								<!--<span style='font-size:10px;color:red;'></span>-->
							<span>
						</a>
					</div>
										<div class="story item">
						<a href="https://www.iiuc.ac.bd/home/news-details/177">
							<span>
								<img src="https://www.iiuc.ac.bd/home/show-image/news4dZfTMdaau8PzjIZ8h9R20214dZfTMdaau8PzjIZ8h9R177-news-7108mz6HpP0nio2mUtRFuJcx" width="260px" height="125px">
							</span>
							<span>
								<span style='font-size:12px;'><b>জাতীয় শোক দিবস ২০২১ উপলক্ষে আইআইইউসিতে রচনা প্রতিযোগিতা</b><span><br/>
								<!--<span style='font-size:10px;color:red;'></span>-->
							<span>
						</a>
					</div>
										<div class="story item">
						<a href="https://www.iiuc.ac.bd/home/news-details/176">
							<span>
								<img src="https://www.iiuc.ac.bd/home/show-image/news4dZfTMdaau8PzjIZ8h9R20214dZfTMdaau8PzjIZ8h9R176-news-4183mz6HpP0nio2mUtRFuJcx" width="260px" height="125px">
							</span>
							<span>
								<span style='font-size:12px;'><b>আইআইইউসি বোর্ড অব ট্রাস্টিজের সভা অনুষ্ঠিত</b><span><br/>
								<!--<span style='font-size:10px;color:red;'>আল্লামা শাহ আবদুল জব্বার (রাহ.) হল নির্মাণের   সিদ্ধান্ত গৃহীত</span>-->
							<span>
						</a>
					</div>
										<div class="story item">
						<a href="https://www.iiuc.ac.bd/home/news-details/175">
							<span>
								<img src="https://www.iiuc.ac.bd/home/show-image/news4dZfTMdaau8PzjIZ8h9R20214dZfTMdaau8PzjIZ8h9R175-news-3001mz6HpP0nio2mUtRFuJcx" width="260px" height="125px">
							</span>
							<span>
								<span style='font-size:12px;'><b>আন্তর্জাতিক ইসলামিক বিশ্ববিদ্যালয় চট্টগ্রাম (আইআইইউসি) এর চতুর্থ শ্রেণীর কর্মচারীদের মাঝে ত্রাণ সামগ্রী বিতরণ</b><span><br/>
								<!--<span style='font-size:10px;color:red;'></span>-->
							<span>
						</a>
					</div>
										<div class="story item">
						<a href="https://www.iiuc.ac.bd/home/news-details/174">
							<span>
								<img src="https://www.iiuc.ac.bd/home/show-image/news4dZfTMdaau8PzjIZ8h9R20214dZfTMdaau8PzjIZ8h9R174-news-6174mz6HpP0nio2mUtRFuJcx" width="260px" height="125px">
							</span>
							<span>
								<span style='font-size:12px;'><b>প্রফেসর মোহাম্মদ আলীর ইন্তেকালে আইআইইউসি ট্রাস্ট চেয়ারম্যান ও ভিসি&apos;র শোক জ্ঞাপন</b><span><br/>
								<!--<span style='font-size:10px;color:red;'></span>-->
							<span>
						</a>
					</div>
										<div class="story item">
						<a href="https://www.iiuc.ac.bd/home/news-details/173">
							<span>
								<img src="https://www.iiuc.ac.bd/home/show-image/news4dZfTMdaau8PzjIZ8h9R20214dZfTMdaau8PzjIZ8h9R173-news-4276mz6HpP0nio2mUtRFuJcx" width="260px" height="125px">
							</span>
							<span>
								<span style='font-size:12px;'><b>আইআইইউসি ক্যাম্পাসে মাসব্যাপী বৃক্ষরোপণ কর্মসূচির উদ্বোধন করলেন ড.আবু রেজা নদভী এমপি।</b><span><br/>
								<!--<span style='font-size:10px;color:red;'></span>-->
							<span>
						</a>
					</div>
										<div class="story item">
						<a href="https://www.iiuc.ac.bd/home/news-details/172">
							<span>
								<img src="https://www.iiuc.ac.bd/home/show-image/news4dZfTMdaau8PzjIZ8h9R20214dZfTMdaau8PzjIZ8h9R172-news-4746mz6HpP0nio2mUtRFuJcx" width="260px" height="125px">
							</span>
							<span>
								<span style='font-size:12px;'><b>CRP organized a Ph.D. Proposal Defense of Mr. Muhammad Alauddin (UniMAP student, Malaysia)</b><span><br/>
								<!--<span style='font-size:10px;color:red;'></span>-->
							<span>
						</a>
					</div>
										<div class="story item">
						<a href="https://www.iiuc.ac.bd/home/news-details/171">
							<span>
								<img src="https://www.iiuc.ac.bd/home/show-image/news4dZfTMdaau8PzjIZ8h9R20214dZfTMdaau8PzjIZ8h9R171-news-1399mz6HpP0nio2mUtRFuJcx" width="260px" height="125px">
							</span>
							<span>
								<span style='font-size:12px;'><b>আইআইইউসি&apos;র ভিসি হিসেবে প্রফেসর আনোয়ারুল আজিম আরিফের দায়িত্বভার গ্রহন</b><span><br/>
								<!--<span style='font-size:10px;color:red;'></span>-->
							<span>
						</a>
					</div>
										<div class="story item">
						<a href="https://www.iiuc.ac.bd/home/news-details/170">
							<span>
								<img src="https://www.iiuc.ac.bd/home/show-image/news4dZfTMdaau8PzjIZ8h9R20214dZfTMdaau8PzjIZ8h9R170-news-5599mz6HpP0nio2mUtRFuJcx" width="260px" height="125px">
							</span>
							<span>
								<span style='font-size:12px;'><b>বঙ্গবন্ধুর জন্ম না হলে বাংলাদেশ নামে প্রিয় মাতৃভূমির জন্মই হতো না</b><span><br/>
								<!--<span style='font-size:10px;color:red;'>আইআইইউসি&apos;তে আলোচনা সভায় প্রফেসর ড. আবু রেজা নদভী এমপি</span>-->
							<span>
						</a>
					</div>
										<div class="story item">
						<a href="https://www.iiuc.ac.bd/home/news-details/169">
							<span>
								<img src="https://www.iiuc.ac.bd/home/show-image/news4dZfTMdaau8PzjIZ8h9R20214dZfTMdaau8PzjIZ8h9R169-news-4680mz6HpP0nio2mUtRFuJcx" width="260px" height="125px">
							</span>
							<span>
								<span style='font-size:12px;'><b>দেশের সর্বস্তরে বাংলা ভাষা প্রচলনে জাতীয় শিক্ষা নীতিতে দিকনির্দেশনা থাকা দরকার</b><span><br/>
								<!--<span style='font-size:10px;color:red;'>আইআইইউসি’র একুশের আলোচনায় প্রফেসর গোলাম মহিউদ্দীন</span>-->
							<span>
						</a>
					</div>
										<div class="story item">
						<a href="https://www.iiuc.ac.bd/home/news-details/168">
							<span>
								<img src="https://www.iiuc.ac.bd/home/show-image/news4dZfTMdaau8PzjIZ8h9R20214dZfTMdaau8PzjIZ8h9R168-news-7621mz6HpP0nio2mUtRFuJcx" width="260px" height="125px">
							</span>
							<span>
								<span style='font-size:12px;'><b>আইআইইউসি’র সিভিল ইঞ্জিনিয়রিং বিভাগ যাত্রা শুরু করলো অনুষ্ঠিত হলো প্রথম ক্লাস</b><span><br/>
								<!--<span style='font-size:10px;color:red;'>আইআইইউসি’র সাফল্যের মুকুটে যুক্ত হলো আরেকটি উজ্জ্বল পালক</span>-->
							<span>
						</a>
					</div>
										<div class="story item">
						<a href="https://www.iiuc.ac.bd/home/news-details/166">
							<span>
								<img src="https://www.iiuc.ac.bd/home/show-image/news4dZfTMdaau8PzjIZ8h9R20204dZfTMdaau8PzjIZ8h9R166-news-9837mz6HpP0nio2mUtRFuJcx" width="260px" height="125px">
							</span>
							<span>
								<span style='font-size:12px;'><b>আমাদের বিজয়ের পঞ্চাশ বছরেও দেশে সাম্য প্রতিষ্ঠা হয়নি, মুক্তিযুদ্ধে অংশগ্রহণকারী মেহনতি মানুষের ভাগ্য বদলায়নি</b><span><br/>
								<!--<span style='font-size:10px;color:red;'>বিজয় দিবসে আইআইইউসি’র আলোচনায় ভিসি প্রফেসর গোলাম মহিউদ্দিন</span>-->
							<span>
						</a>
					</div>
										<div class="story item">
						<a href="https://www.iiuc.ac.bd/home/news-details/165">
							<span>
								<img src="https://www.iiuc.ac.bd/home/show-image/news4dZfTMdaau8PzjIZ8h9R20204dZfTMdaau8PzjIZ8h9R165-news-6947mz6HpP0nio2mUtRFuJcx" width="260px" height="125px">
							</span>
							<span>
								<span style='font-size:12px;'><b>বাধা থাকবে তবুও  এগিয়ে যেতে হবে</b><span><br/>
								<!--<span style='font-size:10px;color:red;'>আইআইইউসি’র অনুষ্ঠানে ড. আলী আজাদী</span>-->
							<span>
						</a>
					</div>
										<div class="story item">
						<a href="https://www.iiuc.ac.bd/home/news-details/161">
							<span>
								<img src="https://www.iiuc.ac.bd/home/show-image/news4dZfTMdaau8PzjIZ8h9R20204dZfTMdaau8PzjIZ8h9R161-news-5216mz6HpP0nio2mUtRFuJcx" width="260px" height="125px">
							</span>
							<span>
								<span style='font-size:12px;'><b>আইআইইউসি’র ক্যারিয়ার-ডিজিটাল মার্কেটিং  বিষয়ে ভার্চুয়াল কর্মশালা শুরু হচ্ছে আজ</b><span><br/>
								<!--<span style='font-size:10px;color:red;'>আইআইইউসি’র ক্যারিয়ার-ডিজিটাল মার্কেটিং  বিষয়ে ভার্চুয়াল কর্মশালা শুরু হচ্ছে আজ</span>-->
							<span>
						</a>
					</div>
...
<div class="container-fluid">
	<div  class="row">
		<div style="background:white;" class="container  well">
			<div class="col-sm-6">
				<div class="event" style="background: linear-gradient(to bottom, #005C25 0%,#005C25 100%); padding: 10px; color: #fff; font-size: 17px; font-weight: bold;">
					<b>Highlights</span></b> 
				</div>
				<div class="row centers">
											<div class="col-lg-12 center6">
							<a href="http://iciset.iiuc.ac.bd/">ICISET 2022 - International Conference on Innovations in Science, Engineering and Technology 2022</a>
						</div>
												<div class="col-lg-12 center6">
							<a href="https://www.iiuc.ac.bd/home/notice/303">Celebration of International Mother Language Day</a>
						</div>
												<div class="col-lg-12 center6">
							<a href="https://www.iiuc.ac.bd/home/mujib-100">100th Birth Anniversary of Bangabandhu Sheikh Mujibur Rahman</a>
						</div>
												<div class="col-lg-12 center6">
							<a href="https://techfest.iiuc.ac.bd">Techfest 2020</a>
						</div>
												<div class="col-lg-12 center6">
							<a href="http://so.iiuc.ac.bd">Divisional Science Olympiad-2020</a>
						</div>
												<div class="col-lg-12 center6">
							<a href="https://icbiid.iiuc.ac.bd/">ICBIID 2019</a>
						</div>
												<div class="col-lg-12 center6">
							<a href="http://iciset2018.iiuc.ac.bd">ICISET 2018</a>
						</div>
												<div class="col-lg-12 center6">
							<a href="https://so.iiuc.ac.bd">Science Olympiad 2018</a>
						</div>
												<div class="col-lg-12 center6">
							<a href="https://www.iiuc.ac.bd/conference">International conference on World Peace and Security
–Role of Islam
ICWPSRI 2017</a>
						</div>
			...
			<div class="col-sm-6">
				<div class="event" style="background: linear-gradient(to bottom, #005C25 0%,#005C25 100%); padding: 10px; color: #fff; font-size: 17px; font-weight: bold;">
					<b>IIUC 4th Convocation</span></b> 
				</div>
				<div style="position:relative;height:0;padding-bottom:75.0%"><iframe src="https://www.youtube.com/embed/PdSJbCw1HY4?ecver=2" width="480" height="360" frameborder="0" allow="autoplay; encrypted-media" style="position:absolute;width:100%;height:100%;left:0" allowfullscreen></iframe></div>
			</div>
		</div>
	</div>
</div>
...
<section style="padding-top:20px;background:#c8d8d7;">
	<div class="container-fluid">
		<div class="row">
				<div  class="col-sm-6">
					<div>
													<h1 align="center" style="color:#005C25;font-weight:bold;">IIUC Central Library</h1>
											</div>
					<div>
						<p style="font-size:1em;" align="justify">
						Since its inception in 1995, International Islamic University Chittagong (IIUC) authority has been taking all possible steps to build up a well-equipped modern library. Now it becomes one of the most extensive libraries among all the private university libraries of Bangladesh. Besides, the university has a Female Academic Zone Library and two seminar libraries (Pharmacy Seminar Library and MBA Seminar Library). The libraries are running under Library and Information Division (LID). The library can accommodate easily over 456 users at a time in its full air-conditioned reading room. The library operates a network of CCTV camera inside the library to ensure the security of itself and also its resources. The library collections are being arranged according to the DDC scheme.
						<br/><br/>
						The library is now fully automated through KOHA Integrated Library System. The IIUC Digital Institutional Repository is developed using DSpace software where all the publications are being published. To help the research-related activities of the university, the services of Turnitin plagiarism checker, Grammarly grammar checker, EBSCO discovery service, RemoteXs remote access service to e-resources, Zotero reference and citation management software are available at IIUC Central Library. 
						<br/><br/>
						The library has about 85500 books of 12000 titles, 1750 journals, and 515 audio-visual materials. Access and download facilities of about 35000 online journals, 15500 eBooks, and four million e-Theses are available. In addition to these collections, the library subscribes printed issues of a large number of journals, foreign and local magazines, and almost all leading national newspapers of Bangladesh.
						<br/><a href="https://www.iiuc.ac.bd/library/about"><button type="button" class="btn btn-sm btn-primary">Read More ..</button></a>
						</p>
					</div>					
					
				</div>
				<div  class="col-sm-6">	
											<img src="https://www.iiuc.ac.bd/home/show-image/department4dZfTMdaau8PzjIZ8h9Rcentral-librarymz6HpP0nio2mUtRFuJcx" alt="iiuc" style="max-width:105%;margin-right:-30px;padding-bottom:5px;" class="img img-responsive" />			
									</div>
		...
		<div class="footer">
				...
				<div class="row">
					<div style="text-align:center;" class="col-sm-12">
						<img src="https://www.iiuc.ac.bd/home/show-image/images4dZfTMdaau8PzjIZ8h9RiiuclogocdNHvOtQ2AD9TLJcKorf" align="center" style="margin-top:-110px;border:2px solid rgba(59,183,120,1);height:200px;background:white;z-index:9999;" alt="IIUC">
					</div>
				</div>
				<div class="row">
					
					<div class="col-sm-2">
						<h3 style="font-weight:bold;font-size:20px;">IIUC</h3>
						<ul>
							<li><a href="https://www.iiuc.ac.bd/about/former-vc-pro-vc">Former VC & Pro-VC</a></li>
							<li><a href="https://www.iiuc.ac.bd/about/mission">Mission &amp; Vision</a></li>
							<li><a href="https://www.iiuc.ac.bd/academic/asystem">Academic System</a></li>
							<li><a href="https://www.iiuc.ac.bd/about/forien-collaboration">Foreign Collaboration</a></li>
							<li><a href="https://www.iiuc.ac.bd/program/financial-info">Financial Information</a></li>
							<li><a href="https://www.iiuc.ac.bd/academic/policies">Academic Policies</a></li>
							<li><a href="https://www.iiuc.ac.bd/research/google-scholar">Google Scholar Profile</a></li>
							<li><a href="https://www.iiuc.ac.bd/administration/coe">Controller of Examinations Office</a></li>
							<li><a href="http://www.webometrics.info/en/Asia/Bangladesh" target="_blank">IIUC Ranking</a></li>  
						</ul>
					</div>
					<div class="col-sm-2">
						<h3 style="font-weight:bold;font-size:20px;">Feature Link</h3>
						<ul>
							
							                          	
							<li><a href="https://www.iiuc.ac.bd/login">New Web Panel</a></li>
							<li><a href="https://www.iiuc.ac.bd/home/verify-admit">Verify Admit Card</a></li>
							<li><a href="http://upanel.iiuc.ac.bd:8081">Old Teachers Web Panel</a></li>
							<li><a href="http://upanel.iiuc.ac.bd:81">Old Students Web Panel</a></li>
							<li><a href="https://www.iiuc.ac.bd/home/rpassword">Request Password</a></li>
							
							<li>
								Email Account Open Form 
								<a href="https://www.iiuc.ac.bd/home/show-pdf/files4dZfTMdaau8PzjIZ8h9REmail-Account-FormT4CIV47CEU5qOj2ShAtD" style="padding:2px;" class="btn btn-info"><i class="fa fa-file-pdf-o"></i> PDF</a>
								<a href="https://www.iiuc.ac.bd/home/show-docx/files4dZfTMdaau8PzjIZ8h9REmail-Account-Form-docyPXRe1kppleuMpFE0ewg" style="padding:2px;" class="btn btn-info"><i class="fa fa-file-word-o"></i> DOC</a>
							</li>
							
							<li><a href="https://www.iiuc.ac.bd/home/show-pdf/files4dZfTMdaau8PzjIZ8h9RUpdate-PABX-Extn-11-11-2020T4CIV47CEU5qOj2ShAtD">PABX Extension</a></li>
							<li><a href="https://www.iiuc.ac.bd/home/show-pdf/files4dZfTMdaau8PzjIZ8h9RImportant-info-teachersT4CIV47CEU5qOj2ShAtD">Important Information for Faculty & Staff</a></li>
						</ul>
					</div>

					<div class="col-sm-2">
						<h3 style="font-weight:bold;font-size:20px;">Admission</h3>
						<ul>
							<li><a href="https://www.iiuc.ac.bd/home/apply-online">Apply Online</a></li>
							<li><a href="https://www.iiuc.ac.bd/home/admission-instruction">How to Apply</a></li>
							<li><a href="https://www.iiuc.ac.bd/program/advertisements">Admission Advertisement</a></li>
							<li><a href="https://www.iiuc.ac.bd/home/daform">Download Admission Form</a></li>
							<li><a href="https://www.iiuc.ac.bd/home/dacard">Download Admit Card</a></li>														
							<li><a href="https://www.iiuc.ac.bd/home/offletter">Download Offer Letter</a></li>
							<li><a href="https://www.iiuc.ac.bd/home/test-result">Admission Test Result</a></li>
							<li><a href="https://www.iiuc.ac.bd/program/program-fees">Program Wise Fees and Charges</a></li>
							<li><a href="https://www.iiuc.ac.bd/home/show-pdf/files4dZfTMdaau8PzjIZ8h9RID-FormT4CIV47CEU5qOj2ShAtD">Student ID Card Reissue Form</a></li>							
						</ul>					
					</div>
					
					<div class="col-sm-2">
						<h3 style="font-weight:bold;font-size:20px;">Resources</h3>
						<ul>
							<li><a href="https://www.iiuc.ac.bd/home/show-pdf/admission4dZfTMdaau8PzjIZ8h9Radmission-handbookT4CIV47CEU5qOj2ShAtD">Admission Handbook</a></li>
							<li><a href="https://www.iiuc.ac.bd/program/credit-transfer">Credit Transfer Information</a></li>
							<li><a href="https://www.iiuc.ac.bd/home/certificate-verification">Certificate Verification</a></li>								
							<li><a href="https://www.iiuc.ac.bd/iqac">IQAC</a> </li>
							<li><a href="https://www.iiuc.ac.bd/research/crp">Research and Publication</a></li>
							<li><a href="https://www.iiuc.ac.bd/videos">Videos</a></li>
							<li><a href="https://www.iiuc.ac.bd/research/journal">Journals published by IIUC</a></li>
							<li><a href="https://www.iiuc.ac.bd/home/notice">Notice</a></li>
							<li><a href="https://www.iiuc.ac.bd/research/publication">Research Publication</a></li>
							<li><a href="https://www.iiuc.ac.bd/home/email-terms">Email Terms & Condition</a></li>
							<li><a href="https://www.iiuc.ac.bd/downloads/realpath/files/Software-Requirement.pdf">Software Requirment Form</a></li>
						</ul>					
					</div>
					<div class="col-sm-2">
						<h3 style="font-weight:bold;font-size:20px;">Campus Life</h3>
						<ul>
							...
							<li><a href="https://www.iiuc.ac.bd/iqac/rules-regulations-hall">Rules and Regulations of Residence Hall</a></li>
							<li><a href="https://www.iiuc.ac.bd/iqac/academic-guideline">Academic Guidance and Counseling</a></li>							
							<li><a href="https://www.iiuc.ac.bd/home/show-pdf/files4dZfTMdaau8PzjIZ8h9RStudent-Email-Account-FormT4CIV47CEU5qOj2ShAtD">Student Email Account Open Form</a></li>
							<li><a href="https://outlook.office365.com">Student Email Access</a></li>
							<li><a href="https://www.iiuc.ac.bd/home/show-pdf/files4dZfTMdaau8PzjIZ8h9RStudent-Important-InformationT4CIV47CEU5qOj2ShAtD">Important Information-for Student</a></li>
							<li><a href="https://www.iiuc.ac.bd/home/notice/200">How to Register Course (Instruction)</a></li>
						</ul>
					</div>
					<div class="col-sm-2">
						<h3 style="font-weight:bold;font-size:20px;">Important Links</h3>
						<ul>
							<li><a href="https://library.iiuc.ac.bd">IIUC Central Library</a></li>
							<li><a href="https://opac.iiuc.ac.bd">Library Catalogue</a></li>
							<li><a href="https://dspace.iiuc.ac.bd">IIUC Reporsitory</a></li>								
							<li><a href="https://eee.iiuc.ac.bd">Department of EEE</a> </li>
							<li><a href="https://qsis.iiuc.ac.bd">Department of QSIS</a></li>
							<li><a href="https://dis.iiuc.ac.bd">Department of DIS</a></li>
							<li><a href="https://shis.iiuc.ac.bd">Department of SHIS</a></li>
							<li><a href="http://www.ugc.gov.bd">UGC, Bangladesh</a></li>
							<li><a href="http://www.moedu.gov.bd/">Ministry of Education, Bangladesh</a></li>
						</ul>
					</div>
				</div>
				<div style="clear:both;">&nbsp;</div>
				...
				<div class="row">
					<div style="text-align:center;" class="col-sm-12">
						<div style="text-align:center;position:inherit;margin-top:10px;" class="icon-bar">
						  <a href="https://www.facebook.com/iiuc.ac.bd" style="width:60px;display:inline;" class="facebook"><i class="fa fa-facebook"></i></a>
						  <a href="https://g.page/IIUCTG?gm"  style="width:60px;display:inline;"class="google"><i class="fa fa-google"></i></a> 
						  <a href="https://www.linkedin.com/company/iiuctg" style="width:60px;display:inline;" class="linkedin"><i class="fa fa-linkedin"></i></a>
						  <a href="https://www.youtube.com/channel/UCFEmMrxH8gYUlTwSdLvjbhA" style="width:60px;display:inline;" class="youtube"><i class="fa fa-youtube"></i></a> 
				...
				<div class="row">
					<div style="text-align:center;" class="col-sm-12">
						<div id="fb-root"></div>
						<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v6.0&appId=503167123063315&autoLogAppEvents=1"></script>
						<div class="fb-like" data-href="https://www.facebook.com/iiuc.ac.bd" data-width="350" data-layout="standard" data-action="like" data-size="small" data-share="true"></div>
					</div>
				</div>
				<div class="row">
					<div style="text-align:center;" class="col-sm-12">
						<h4 style="font-weight:bold;color:white;font-family:Rajdhani;" align="center">International Islamic University Chittagong | Kumira, Chattogram-4318 | +88-03042-51154-61</h4>
					</div>
				</div>
			</div>
					</div>
		...
		<div class="footer_bottom">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<p>
							Copyright  © <script>document.write(new Date().getFullYear());</script> All rights reserved IIUC and <a href="https://www.iiuc.ac.bd/home/developed" style="color:orange">Developed by</a>
						</p>
					</div>
				</div>
			</div>
